package com.pokeapi.presentation.screen.mypokemon.section
...
import com.pokeapi.presentation.screen.mypokemon.MyPokemonViewModel
 ...
 */
@Composable
fun MyPokemonContent(
    modifier: Modifier,
    data :MutableList<DBMyPokemon>,
...
//                columns = GridCells.Adaptive(128.dp),
                ...
                content = {
                    items (count = data.size){ index ->
                        ...
                        var name = pokemon.nickname+if(pokemon.index!! > 0) "-"+pokemon.fibbonaci!! else ""
                        var setPokemon = Pokemon()
                        setPokemon.id = pokemon.id
                        setPokemon.name = name
                        setPokemon.image = pokemon.image
                        PokemonItem(
                            modifier = Modifier,
                            data = setPokemon,
                            onClick = {
